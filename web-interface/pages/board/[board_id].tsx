    ...
    <div className={dashboard.pageWrap} ref={pageRef}>
      ...
      <div className={dashboard.boardPageWrapScroll}>
        ...
        <div>
          ...
          {workflow.type === 1 &&
            <InitiativesWorkflow data={workflow.columns} users={workflow.users} workflow_name={workflow.name} showInitiativeModal = {showInitiativeModal} updateCurrentInitiativeCard = {updateCurrentInitiativeCard}/>
          }
