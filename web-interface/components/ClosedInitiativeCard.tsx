...
const InitiativeCard = ({card_id, color, owner_avatar, title, owner_username, lane_name, lane_color, child_complete, child_total, showInitiativeModal, retrieveIndex} : InitiativeCardProps) =>{

    const handleClick = () =>{
        showInitiativeModal(true);
